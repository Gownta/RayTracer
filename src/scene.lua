...
cyl = gr.node('cylinder dad')
cyl:add_child(cylinder)
...
s3:scale(1.2, 1.2, 1.2)

fss = gr.csg('funnier', fs, '*', s3, 1.731)

--

ci = gr.algebraic('infinite cone', 'x^2 + z^2 - (y - 1)^2', 1)
ci:set_material(mat1)
hp = gr.algebraic('halfcut plane', '(y - 0.5)^2 - 0.5^2', 2)
hp:set_material(mat2)
