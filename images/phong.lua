...
orange= gr.material({1,0.6,0},{0.7,0.4,0.0}, 25)
purple= gr.material({0.6,0.2,1},{0.2,0.2,0.2},25)
magenta=gr.material({0.8,0,0.7},{0.2,0.3,0.1},25)
yellow= gr.material({1,0.8,0.1},{0.8,0.8,0.8},25)
floor = gr.material({0.8,0.8,0.8},{0,0,0}, 1, 0.7)
stone = gr.material({0.8, 0.7, 0.7}, {0.4, 0.4, 0.4}, 25)

-------------------
-- Buckyballs

buckyball2 = gr.mesh( 'buckyball', 
        { -- vertices
...
buckyball2:set_material(orange)
buckyball2:scale(1.5, 1.5, 1.5)
buckyball2:translate(4,0,0)

require('buckyball')
scene:add_child(buckyball)
buckyball:set_material(orange)
buckyball:scale(1.5, 1.5, 1.5)
buckyball:translate(-4,0,0)
...
rc1 = gr.cube('lx')
rc1:translate(-0.5,-0.5,-0.5)
rc1:scale(1,3,1)
rc1:rotate('Z', 45)
rc1:translate(-4,7,0)
rc1:set_material(red)
scene:add_child(rc1)

rc2 = gr.cube('rx')
rc2:translate(-0.5,-0.5,-0.5)
rc2:scale(1,3,1)
rc2:rotate('Z',-45)
rc2:translate(-4,7,0)
rc2:set_material(red)
scene:add_child(rc2)


gc1 = gr.cube('sc')
gc1:translate(-0.5,-0.5,-0.5)
gc1:scale(1,2,1)
gc1:translate(0,0.5,0)
gc1:rotate('Z', 45)
gc1:translate( 4,6.5,0)
gc1:set_material(green)
scene:add_child(gc1)

gc2 = gr.cube('sc')
gc2:translate(-0.5,-0.5,-0.5)
gc2:scale(1,3,1)
gc2:translate(0,1,0)
gc2:rotate('Z',-45)
gc2:translate( 4,6.5,0)
gc2:set_material(green)
scene:add_child(gc2)
