...
cover = gr.mesh('book cover',
  { -- vertices
    ...
    {{0,1,2,3},{1,1,0,0},{0,4,5,1}},
    {{2,3,4,5},{},{6,2,3,7}},
  })
cover:set_material(gr.texture_material('book.png', {0,0,0}, 1))
book:add_child(cover)

pages = gr.mesh('book pages',
  { -- vertices
    {0,0,1},
    {0,1,1},
    {1,1,1},
...
pages:set_material(gr.texture_material('pages.png', {0,0,0}, 1))
book:add_child(pages)

book:scale(0.2,0.1,0.3)
book:rotate('Y', 10)
book:translate(1.5,0,0.4)
